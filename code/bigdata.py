...
class bigdata(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._sig_src_callback = lambda i: Qt.QMetaObject.invokeMethod(self._sig_src_button_group, "updateButtonChecked", Qt.Q_ARG("int", self._sig_src_options.index(i)))
        ...
        self._amplitude_win = RangeWidget(self._amplitude_range, self.set_amplitude, 'Volume', "counter_slider", float)
